...
import { registerSetLangDirCommand } from "./check/setLangDirCommand";
import { registerSetProjectRootCommand } from "./check/setProjectRootCommand";
...
export function registerAllCommands() {
  ...
  registerSetLangDirCommand();
  registerSetProjectRootCommand();
