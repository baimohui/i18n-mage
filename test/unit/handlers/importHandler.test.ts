...
describe("core/handlers/ImportHandler", () => {
  ...
  it("header 无 key 列应返回 ImportNoKey", () => {
    mockRequire("fs", { existsSync: () => true });
    mockRequire(
      "node-xlsx",
      parseMock([
