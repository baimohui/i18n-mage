export function printTitle(str: string = ""): void {
  ...
  console.info(`\n${"🤖".repeat(isDivisible ? robotSideNum : robotSideNum - 1)}` + ` \x1b[1;37m${str}\x1b[0m ` + "🤖".repeat(robotSideNum));
}

export type PrintType = "success" | "error" | "puzzle" | "shock" | "brain" | "rocket" | "ghost" | "demon" | "mage";

export function printInfo(str: string = "", type: PrintType): void {
